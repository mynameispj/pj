...
<div class="line-item-summary">
	...
	<?php endif; ?>
	<div class="credtCards"><p>All major credit cards are accepted. Payment is processed through Paypal. You totally don't even need a Paypal account&mdash;just select "Don't have a Paypal account?" when you're taken to Paypal.</p>
	<p><strong>Got a coupon?</strong> You can add it in the following page.</p></div>
	<?php print $links; ?>
</div>
