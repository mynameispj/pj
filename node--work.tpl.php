...
?>
  ...
  <div id="body" class="<?php print strtolower(str_replace(" ", "",check_plain($node->title)))  ?>">
	...
	<div id="lead">
		...
		<?php if (render($content['field_work_link']) == "") {?>
			<?php print render($content['field_work_images'] ); ?>
			
			
		<?php } else { ?>
			<a href="<?php print render($content['field_work_link']); ?>" class="sitelink" rel="nofollow">
				<div class="notice link">Click to visit the <?php print check_plain($node->title) ?> site</div>
				<?php print render($content['field_work_images'] ); ?>
			</a>
		<?php } ?>
    ...
    <div id="words">
    	...
    	<?php print render($content['field_work_other_images'] ); ?>
    	<?php // print render($content['field_images_other_images'] ); ?>
